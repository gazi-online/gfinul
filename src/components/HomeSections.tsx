...
import { BadgeCheck, CreditCard, Droplets, FileText, Gift, Home, Landmark, Lightbulb, MapPin, Receipt, ShieldCheck, Smartphone, Truck, type LucideIcon, Zap } from 'lucide-react'
  ...
  return (
    <section id="popular-services" className="px-3 lg:px-8 mt-6 lg:mt-10">
      <div className="flex items-center justify-between mb-3 lg:mb-5">
        <h2 className="text-base lg:text-xl font-bold text-gray-900 dark:text-white">{title}</h2>
        <button
...
export const RecentApplicationsSection: React.FC<{ title?: string }> = ({ title = "Recent Applications" }) => {
  ...
  return (
    <section id="recent-applications" className="px-3 lg:px-8 mt-10 lg:mt-16 mb-8 lg:mb-16">
      <h2 className="text-base lg:text-2xl font-bold text-gray-900 dark:text-white mb-5 lg:mb-8">{title}</h2>
  ...
  return (
    <section id="quick-services-grid" className="px-3 lg:px-8 mt-8 lg:mt-14">
      <div className="flex items-center justify-between mb-5 lg:mb-8">
        <h2 className="text-base lg:text-2xl font-extrabold text-gray-900 dark:text-white">{title}</h2>
        <button
          type="button"
          onClick={onViewAll}
...
const formatProductPrice = (value: unknown) => {
  ...
  return parsedPrice === null ? 'Rs 0' : `Rs ${parsedPrice.toLocaleString('en-IN')}`
}
