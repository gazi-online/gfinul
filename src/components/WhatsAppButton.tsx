...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip on Desktop */}
      <span className="absolute right-full mr-4 bg-white dark:bg-slate-800 text-gray-900 dark:text-white px-3 py-1.5 rounded-lg font-bold text-xs shadow-xl opacity-0 group-hover:opacity-100 transition-opacity translate-x-2 group-hover:translate-x-0 hidden lg:block whitespace-nowrap pointer-events-none border border-gray-100 dark:border-slate-700">
        Chat with Us
      </span>
    </button>
  );
