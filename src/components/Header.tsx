...
const ServicesNavIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.9} stroke="currentColor" className="w-4 h-4">
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6A2.25 2.25 0 0 1 6 3.75h2.25A2.25 2.25 0 0 1 10.5 6v2.25A2.25 2.25 0 0 1 8.25 10.5H6A2.25 2.25 0 0 1 3.75 8.25V6ZM3.75 15.75A2.25 2.25 0 0 1 6 13.5h2.25a2.25 2.25 0 0 1 2.25 2.25V18a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18v-2.25ZM13.5 6a2.25 2.25 0 0 1 2.25-2.25H18A2.25 2.25 0 0 1 20.25 6v2.25A2.25 2.25 0 0 1 18 10.5h-2.25a2.25 2.25 0 0 1-2.25-2.25V6ZM13.5 15.75a2.25 2.25 0 0 1 2.25-2.25H18a2.25 2.25 0 0 1 2.25 2.25V18A2.25 2.25 0 0 1 18 20.25h-2.25A2.25 2.25 0 0 1 13.5 18v-2.25Z" />
  </svg>
)
...
const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    ...
    <header 
      id="app-header" 
      className="sticky top-0 z-40 w-full h-16 flex items-center justify-between px-4 lg:px-6 bg-white/95 dark:bg-slate-900/95 border-b border-gray-200 dark:border-slate-700 transition-colors duration-300"
    >
      <div className="flex items-center justify-between w-full max-w-7xl mx-auto h-full">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-lg lg:text-xl font-black text-gray-900 dark:text-white tracking-tight">
            {title}
          </h1>
        </div>
        ...
        <div className="flex items-center gap-3 lg:gap-6">
          {/* Desktop Links */}
            <nav className="hidden lg:flex items-center gap-3" aria-label="Main navigation">
              {NAV_LINKS.filter(l => l.id !== 'profile').map(({ id, label, icon: Icon }) => (
                <button
                  key={id}
                  id={`nav-${id}`}
                  ...
                  `}
                >
                  <span className={`transition-transform duration-300 ${activeTab === id ? '' : 'group-hover:scale-110 group-hover:-translate-y-0.5'}`}>
                    <Icon />
                  </span>
          ...
          <div className="flex items-center gap-3 lg:gap-4">
            ...
            {/* Cart Icon */}
              ...
              >
                ...
                {cartCount > 0 && (
                <span className="absolute top-0 right-0 inline-flex items-center justify-center w-4 h-4 text-[10px] font-bold text-white bg-rose-500 rounded-full border border-white dark:border-slate-900">
